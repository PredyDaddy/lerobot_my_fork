...
# Override at runtime with: GPU_ID=0 bash agilex_scripts/train_smolvla.sh
GPU_ID="${GPU_ID:-7}"
...
INPUT_FEATURES="{\"observation.state\":{\"type\":\"STATE\",\"shape\":[${STATE_DIM}]},\"observation.images.camera1\":{\"type\":\"VISUAL\",\"shape\":[3,256,256]},\"observation.images.camera2\":{\"type\":\"VISUAL\",\"shape\":[3,256,256]},\"observation.images.camera3\":{\"type\":\"VISUAL\",\"shape\":[3,256,256]}}"
...
DEFAULT_RENAME_MAP='{"observation.images.camera_front":"observation.images.camera1","observation.images.camera_left":"observation.images.camera2","observation.images.camera_right":"observation.images.camera3"}'
...
if [[ "${SMOKE_TEST}" == "1" || "${SMOKE_TEST}" == "true" ]]; then
  ...
  OUTPUT_DIR_DEFAULT="${ROOT_DIR}/outputs/train/_smoke_smolvla_agilex_${ACTION_DIM}d_${timestamp}"
  JOB_NAME_DEFAULT="smoke_smolvla_agilex_${ACTION_DIM}d"
else
  BATCH_SIZE_DEFAULT="32"
  STEPS_DEFAULT="100000"
  SAVE_FREQ_DEFAULT="10000"
  LOG_FREQ_DEFAULT="100"
  NUM_WORKERS_DEFAULT="4"
  OUTPUT_DIR_DEFAULT="${ROOT_DIR}/outputs/train/smolvla_agilex_${ACTION_DIM}d"
  JOB_NAME_DEFAULT="smolvla_agilex_${ACTION_DIM}d"
fi
